...
export default function MedicalRecords() {
  ...
  return (
    <>
      <div className="px-8 py-6 flex flex-col gap-10 w-full">
        ...
        <div className="  w-full ">
          <div className="relative">
            {medicalHistories.map((monthGroup, monthIndex) => (
              <div key={monthIndex} className="relative mb-10 pl-12">
              <div className="absolute left-3 top-0 bottom-[-40px] w-[2px] bg-[#D7E4D8]" > </div>
              <div className="absolute left-[2px] top-1 w-5 h-5 rounded-full border-[3px] border-[#667E68FF] bg-white z-10" > </div>

              <h2 className="text-[#667E68FF] font-semibold mb-5">
                {monthGroup.month}
              </h2>
