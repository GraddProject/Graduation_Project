        ...
        <div className='flex flex-col w-full px-3 py-5'>
          ...
          <div className='flex flex-row items-center justify-between w-full border-b-[1px] border-b-[#E8EBE8FF] pb-5'>
            ...
            <div className='flex flex-row items-center gap-2'>
              ...
              <span className='text-[#9196A1FF] text-sm font-medium'>
                {formatDate(addDate)}
              </span>
            </div>
            ...
            {mode === "doctorview" && (
              <div className='flex flex-row items-center gap-2'>
                <div
                  className='w-8 h-8 rounded-full bg-[#F3F4F6FF] flex items-center justify-center cursor-pointer'
                  onClick={() => {
                    setFormData({
                      open: true,
          ...
          <div className='flex flex-col gap-1 border-b-[1px] border-b-[#E8EBE8FF] pb-5'>
            ...
            <div>
              ...
              <p className='text-[#617062e2] mt-1 font-[550] text-sm'>
                {vitalSigns}
              </p>
            </div>

            <p className='mt-3 text-[#7A8F7CFF] text-xs'>
              {notes}
            </p>
          </div>

          {prediction && (
            <div className='bg-[#F7F9F7FF] rounded-xl flex flex-col gap-4 my-2 px-3 py-3'>

              <div className='flex flex-row justify-between items-center'>

                <div className='flex flex-row items-center gap-2'>
                  <h3 className='text-[#6a796b] text-xs font-semibold'>
                    Risk Analysis:
                  </h3>

                  <div
                    className='px-2 text-xs rounded-xl'
                    style={riskStyles?.[normalizeRisk(prediction.riskLevel)]}
                  >
                    {prediction.riskLevel}
                  </div>

                  <p className='text-xs text-[#4A5F4EFF]'>
          ...
          {preScriptions.length !== 0 && (
            <div className='flex flex-col gap-2 border-t-[1px] border-b-[#E8EBE8FF]'>
              ...
              <h3 className='text-[#6a796b] mt-4 uppercase text-xs font-semibold'>
                Prescriptions
              </h3>
