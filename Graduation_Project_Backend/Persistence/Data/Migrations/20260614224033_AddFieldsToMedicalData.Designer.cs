...
namespace Persistence.Data.Migrations
{
    ...
    [Migration("20260614224033_AddFieldsToMedicalData")]
    partial class AddFieldsToMedicalData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainLayer.Models.Appointment", b =>
                {
                    ...
                    b.Property<DateTime?>("ZoomCreatedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("ZoomUpdatedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DomainLayer.Models.PredictionRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Models.MedicalHistory", b =>
                {
                    ...
                    b.HasOne("DomainLayer.Models.PredictionRecord", "PredictionRecord")
                        .WithOne("MedicalHistory")
                        .HasForeignKey("DomainLayer.Models.MedicalHistory", "PredictionRecordId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.OwnsOne("DomainLayer.Models.MedicalData", "MedicalInfo", b1 =>
                        {
                            ...
                            b1.Property<decimal?>("BMI")
                                ...
                                .HasColumnName("BMI")
                                .HasComputedColumnSql("CASE WHEN [Height] IS NULL OR [Weight] IS NULL OR [Height] <= 0 THEN NULL ELSE ROUND((CAST([Weight] AS decimal(18,2)) * 10000.0) / ([Height] * [Height]), 2) END", false);
                            ...
                            b1.Property<bool?>("HadGestationalDiabetesBefore")
                                .HasColumnType("bit")
                                .HasColumnName("HadGestationalDiabetesBefore");

                            b1.Property<bool?>("HadLargeChildOrBirthDefault")
                                .HasColumnType("bit")
                                .HasColumnName("HadLargeChildOrBirthDefault");

                            b1.Property<bool?>("HadPreviousPreeclampsia")
                                .HasColumnType("bit")
                                .HasColumnName("HadPreviousPreeclampsia");

                            b1.Property<bool?>("HadUnexplainedPrenatalLoss")
                                .HasColumnType("bit")
                                .HasColumnName("HadUnexplainedPrenatalLoss");

                            b1.Property<bool?>("HasChronicHypertension")
                                .HasColumnType("bit")
                                .HasColumnName("HasChronicHypertension");

                            b1.Property<bool?>("HasChronicKidneyDisease")
                                .HasColumnType("bit")
                                .HasColumnName("HasChronicKidneyDisease");

                            b1.Property<bool?>("HasFamilyHistoryOfDiabetes")
                                .HasColumnType("bit")
                                .HasColumnName("HasFamilyHistoryOfDiabetes");

                            b1.Property<bool?>("HasFamilyHistoryOfPreeclampsia")
                                .HasColumnType("bit")
                                .HasColumnName("HasFamilyHistoryOfPreeclampsia");

                            b1.Property<bool?>("HasPCOS")
                                .HasColumnType("bit")
                                .HasColumnName("HasPCOS");

                            b1.Property<bool?>("HasPrediabetes")
                                .HasColumnType("bit")
                                .HasColumnName("HasPrediabetes");

                            b1.Property<bool?>("HasPregestationalDiabetes")
                                .HasColumnType("bit")
                                .HasColumnName("HasPregestationalDiabetes");

                            b1.Property<bool?>("HasSedentaryLifestyle")
                                .HasColumnType("bit")
